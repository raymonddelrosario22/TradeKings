...
<body>
	...
	<form action="check.php" method="POST">
		...
		<input type="submit" id="search" name="submit" value="CHECK"> or <a href="setCrypto.php">SET PAGE </a>
		</center>
		<br> <br> <br>
	</form>
...
if($price2[$x]>=$price &&  !$marker3[$x] )  //
{
	...
	@$txt.="The target price for ".$tick2[$x]." has been reached, as its current price is at ".$price." which was less than or equal to your target value of ".$price2[$x]. "\n\n";

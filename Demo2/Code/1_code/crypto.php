...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<div class="grid">
		...
		<div id="cryptoAlert" class="alert">
		<CENTER>	 
	 <div class="header">
...
<center>  
<input type="submit" id="search" name="submit" value="CHECK"> or <a href="crypto.php">SET PAGE </a>
</center>
...
<script>
	...
	function displayAlerts(){
		...
		a = document.getElementById("cryptoAlert");
